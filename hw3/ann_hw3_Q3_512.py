...
"""
target_size = (512, 512)  /  batch_size = 20  /  class_mode = 'binary'
...
## save
model.save("chest_x_ray_pretrained_model_03_512.h5")
...
plot_loss(history)
plt.savefig('Q_03_512-loss.png')
plt.clf()
plot_acc(history)
plt.savefig('Q_03_512-accuracy.png')
plt.clf()
...
history = model.fit_generator(
    train_generator, epochs = EPOCHS2,
    validation_data = val_generator, validation_steps = VAL_STEPS
)
...
plot_loss(history)
plt.savefig('q3_512_afterloss.png')
plt.clf()
plot_acc(history)
plt.savefig('q3_512_afteraccuracy.png')

## save fine-tuning model
model.save("chest_x_ray_2step_03_512.h5")