...
## save
model.save("chest_x_ray_pretrained_model_02.h5")
...
plot_loss(history)
plt.savefig('Q2-loss.png')
plt.clf()
plot_acc(history)
plt.savefig('Q2-accuracy.png')
plt.clf()
...
plot_loss(history)
plt.savefig('q2_afterloss.png')
plt.clf()
plot_acc(history)
plt.savefig('q2_afteraccuracy.png')

## save fine-tuning model
model.save("chest_x_ray_2step_02.h5")